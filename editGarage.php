...
/* empty ErrorMessage array that if elements are met or not runs, either runs the error messege( Reloads createGarageForm.php ) or continues to viewGarage.php */
$errorMessage = array();
